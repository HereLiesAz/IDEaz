...
fun SettingsScreen(
    ...
    // --- NEW: Signing State (Removed for remote build, but keeping UI if user wants to import keystore to upload later?)
    // Actually, remote build doesn't use local keystore directly unless we upload it.
    // For min-app, I'll keep it simple and comment it out or remove it to reduce complexity.
    // I'll remove it.
            ...
            Column(
                ...
                AzButton(
                    onClick = {
                        ...
                        Toast.makeText(context, "Clear Build Caches", Toast.LENGTH_SHORT).show()
                    },
