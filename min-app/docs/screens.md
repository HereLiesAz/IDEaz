...
*   **Content Modes:**
    ...
    *   **Build Log:** Live stream from GitHub Actions (polled).
...
*   **Tabs:**
    ...
    *   **Setup:** **INITIALIZATION happens here.**
        *   Displays Sessions.
        *   "Save & Initialize" button triggers workflow injection and first remote build.
...
*   **Sections:** AI Keys, GitHub Token, Theme.

## 7. Web Runtime (`WebRuntimeActivity.kt`)
*   **Role:** Host for Web projects.
*   **Component:** `WebView` loading the remotely built and downloaded web assets.
