...
import com.hereliesaz.ideaz.minapp.jules.JulesApiClient
import com.hereliesaz.ideaz.minapp.git.GitManager
import com.hereliesaz.ideaz.minapp.services.BuildService
...
import java.io.File
import com.hereliesaz.ideaz.minapp.models.SourceMapEntry
import com.hereliesaz.ideaz.minapp.utils.SourceMapParser
import com.hereliesaz.ideaz.minapp.services.ScreenshotService
import com.hereliesaz.ideaz.minapp.api.GeminiApiClient
import com.hereliesaz.ideaz.minapp.api.CreateSessionRequest
import com.hereliesaz.ideaz.minapp.api.SourceContext
import com.hereliesaz.ideaz.minapp.api.GitHubRepoContext
import com.hereliesaz.ideaz.minapp.api.Source
import com.hereliesaz.ideaz.minapp.buildlogic.HttpDependencyResolver
import com.hereliesaz.ideaz.minapp.utils.SourceContextHelper
import com.hereliesaz.ideaz.minapp.models.IdeazProjectConfig
import com.hereliesaz.ideaz.minapp.models.ProjectType
import com.hereliesaz.ideaz.minapp.api.GitHubApiClient
import com.hereliesaz.ideaz.minapp.api.CreateRepoRequest
import com.hereliesaz.ideaz.minapp.utils.GithubIssueReporter
import com.hereliesaz.ideaz.minapp.utils.ProjectAnalyzer
import com.hereliesaz.ideaz.minapp.utils.ProjectConfigManager
import com.hereliesaz.ideaz.minapp.utils.ToolManager
...
import com.hereliesaz.ideaz.minapp.utils.ApkInstaller
...
class MainViewModel(
    ...
    private val _availableSessions = MutableStateFlow<List<com.hereliesaz.ideaz.minapp.api.Session>>(emptyList())
    ...
    private val visibilityReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            if (intent?.action == "com.hereliesaz.ideaz.minapp.TARGET_APP_VISIBILITY") {
    ...
    init {
        val filter = IntentFilter("com.hereliesaz.ideaz.minapp.TARGET_APP_VISIBILITY")
    ...
    private val buildCallback = object : IBuildCallback.Stub() {
        ...
        override fun onSuccess(apkPath: String) {
            viewModelScope.launch {
                ...
                getApplication<Application>().sendBroadcast(Intent("com.hereliesaz.ideaz.minapp.SHOW_UPDATE_POPUP"))
    ...
    private fun takeScreenshot(rect: Rect) {
        ...
        viewModelScope.launch {
            ...
            sendOverlayBroadcast(Intent("com.hereliesaz.ideaz.minapp.HIDE_OVERLAYS_TEMPORARILY"))
    ...
    fun onScreenshotTaken(base64: String) {
        ...
        sendOverlayBroadcast(Intent("com.hereliesaz.ideaz.minapp.RESTORE_OVERLAYS"))
    ...
    private fun logToOverlay(message: String) {
        sendOverlayBroadcast(Intent("com.hereliesaz.ideaz.minapp.AI_LOG").apply { putExtra("MESSAGE", message) })
    }
        ...
        viewModelScope.launch {
            ...
            withContext(Dispatchers.IO) {
                try {
                    ...
                    val pathStr = com.hereliesaz.ideaz.minapp.utils.UriUtils.getPathFromUri(context, uri)
    ...
    fun deleteSession(s: com.hereliesaz.ideaz.minapp.api.Session) {}
    fun trySession(s: com.hereliesaz.ideaz.minapp.api.Session) {}
    fun acceptSession(s: com.hereliesaz.ideaz.minapp.api.Session) {}
    fun gitDeleteBranch(b: String) {}
    fun getDependencies(): List<com.hereliesaz.ideaz.minapp.ui.Dependency> = emptyList()
    fun saveDependencies(l: List<String>) {}
    suspend fun checkForUpdates(d: com.hereliesaz.ideaz.minapp.ui.Dependency): com.hereliesaz.ideaz.minapp.ui.Dependency = d
}